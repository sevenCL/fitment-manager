package com.seven.library.utils.blur;
...
public class BlurBehind {
    ...
    public void setBackground(Activity activity, boolean clearCache) {
...
//            Bitmap blurredBitmap = Blur.blur(image);
            Bitmap blurredBitmap = Blur.apply(activity, image, CONSTANT_BLUR_RADIUS);
//            Bitmap blurredBitmap = Blur.doBlur(image,CONSTANT_BLUR_RADIUS,false);
