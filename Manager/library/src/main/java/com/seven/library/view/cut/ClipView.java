package com.seven.library.view.cut;
...
//            //中间的透明的圆
//            canvas.drawCircle(this.getWidth() / 2, this.getHeight() / 2, clipRadiusWidth / 2, paint);
//            //白色的圆边框
//            canvas.drawCircle(this.getWidth() / 2, this.getHeight() / 2, clipRadiusWidth / 2, borderPaint);
//        } else if (clipType == ClipType.RECTANGLE) { //绘制矩形裁剪框
//            //绘制中间的矩形
//            canvas.drawRect(this.getWidth() / 2 - clipWidth / 4, this.getHeight() / 2 - clipWidth / 4,
//                    this.getWidth() / 2 + clipWidth / 4, this.getHeight() / 2 + clipWidth / 4, paint);
//            //绘制白色的矩形边框
//            canvas.drawRect(this.getWidth() / 2 - clipWidth / 4, this.getHeight() / 2 - clipWidth / 4,
//                    this.getWidth() / 2 + clipWidth / 4, this.getHeight() / 2 + clipWidth / 4, borderPaint);
//        }
        if (clipType == ClipType.CIRCLE) {
            //中间的透明的圆
    ...
    public Rect getClipRect() {
        Rect rect = new Rect();
//        //宽度的一半 - 圆的半径
//        rect.left = (this.getWidth() / 2 - clipRadiusWidth / 2);
//        //宽度的一半 + 圆的半径
//        rect.right = (this.getWidth() / 2 + clipRadiusWidth / 2);
//        //高度的一半 - 圆的半径
//        rect.top = (this.getHeight() / 2 - clipRadiusWidth / 2);
//        //高度的一半 + 圆的半径
//        rect.bottom = (this.getHeight() / 2 + clipRadiusWidth / 2);
        //宽度的一半 - 圆的半径
